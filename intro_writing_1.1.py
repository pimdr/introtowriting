...
data = [section1[:,5]/section1[:,3],section2[:,5]/section2[:,3],section3[:,5]/section3[:,3],section4[:,5]/section4[:,3],section5[:,5]/section5[:,3],section6[:,5]/section6[:,3]] # ipaqtot1 / total steps
...
#data = [section1[:,7],section2[:,7],section3[:,7],section4[:,7],section5[:,7],section6[:,7]]    #relative estimation error
...
#ax1.set_ylim([-1, 2])               #Change this if you go to estimation or total steps
